            ...
            <nav className='z-20 fixed flex flex-col items-center w-1/6 min-w-56 h-full bg-oxford-blue border-r border-gray-1 pt-16'>
                ...
                <div className='h-fit w-full'>
                    ...
                    <ul className='text-white'>
                        <li className='dashboard-item block mx-4 py-1 pl-8 rounded text-xl transition-all duration-250 hover:pl-10 select-none'><FontAwesomeIcon icon={faBook} />  My Stories</li>
                        <li className='dashboard-item block mx-4 py-1 pl-8 rounded text-xl transition-all duration-250 hover:pl-10 select-none'><FontAwesomeIcon icon={faPencil} />  New Story</li>
                        <li className='dashboard-item block mx-4 py-1 pl-8 rounded text-xl transition-all duration-250 hover:pl-10 select-none'><FontAwesomeIcon icon={faGear} />  Settings</li>
                    </ul>
                </div>
