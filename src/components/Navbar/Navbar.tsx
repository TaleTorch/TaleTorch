                        ...
                        <form>
                            <div className="flex w-2/3">
                                <div className="relative w-full">
                                    <input type="search" id="search-dropdown" className="rounded-l-lg block p-2.5 w-full z-20 text-sm text-gray-200 search-bar-input-bg rounded-e-lg border border-gray-400 focus:border-1 focus:outline-none focus:border-dark-orange" placeholder="Search for stories or authors" required/>
