            ...
            <nav className="z-30 fixed block w-full bg-oxford-blue px-5 py-2 border-b border-gray-400">
                <div className="flex justify-items-center items-center">
                        ...
                        <form>
                            <div className="flex w-2/3">
                                <div className="relative w-full">
                                    ...
                                    <button type="submit" className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white search-bar-btn-bg rounded-e-lg border border-dark-orange focus:ring-2 focus:ring-dark-orange focus:outline-none hover:brightness-90">
                    ...
                    <div className="flex-grow-0 mr-3.5">
                        <button type="button" className="text-white new-story-bg focus:ring-2 focus:ring-dark-orange font-medium rounded-lg text-sm px-5 py-2.5 my-auto hover:brightness-90">New <FontAwesomeIcon icon={faPlus} /></button>
                    </div>
